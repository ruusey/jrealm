...
public class BorderFilter extends AbstractBufferedImageOp {
    ...
    public BufferedImage filter(BufferedImage src, BufferedImage dst) {
        ...
        if (dst == null)
            dst = new BufferedImage(width + this.leftBorder + this.rightBorder,
                    height + this.topBorder + this.bottomBorder, src.getType());
        ...
        g.drawRenderedImage(src, AffineTransform.getTranslateInstance(0, 0));
        g.dispose();
        return dst;
    }
