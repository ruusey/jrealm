...
public class Animation {
	...
	public void setNumFrames(int i, int state) { this.states[state] = i; }
	...
	public boolean hasPlayedOnce() { return this.timesPlayed > 0; }
	public boolean hasPlayed(int i) { return this.timesPlayed == i; }
