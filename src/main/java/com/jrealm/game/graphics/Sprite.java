...
public class Sprite {
	...
	NORMAL, SEPIA, REDISH, GRAYSCALE, NEGATIVE, DECAY
    }
    ...
    private float[][] decay = { { 0.000f, 0.333f, 0.333f }, { 0.333f, 0.000f, 0.333f }, { 0.333f, 0.333f, 0.000f },
	...
	BufferedImage newImage = new BufferedImage(this.image.getWidth(), this.image.getHeight(),
	...
	BufferedImage newImage = new BufferedImage(this.image.getColorModel(),
		this.image.getRaster().createCompatibleWritableRaster(w, h), this.image.isAlphaPremultiplied(), null);
