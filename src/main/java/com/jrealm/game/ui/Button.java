...
public class Button {
    ...
    private BufferedImage createIconButton(BufferedImage icon, BufferedImage image, int width, int height,
        ...
        g.drawImage(icon, (image.getWidth() / 2) - (icon.getWidth() / 2),
                (image.getHeight() / 2) - (icon.getHeight() / 2), icon.getWidth(), icon.getHeight(), null);
    ...
    public Button(String label, BufferedImage image, Font font, Vector2f pos, int buttonWidth, int buttonHeight) {
        ...
        this.image = this.createButton(label, image, font, width + buttonWidth, height + buttonHeight, buttonWidth,
                buttonHeight);
        this.pos = pos;
