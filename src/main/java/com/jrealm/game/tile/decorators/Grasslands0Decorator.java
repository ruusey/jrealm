	...
	public void decorate(final Realm input) {
		for (int i = 0; i < (Grasslands0Decorator.MIN_FOREST_COUNT + Realm.RANDOM
			...
			collisionLayer.setBlockAt(
					(centerX + 1) >= collisionLayer.getWidth() ? collisionLayer.getWidth() - 1 : centerX + 1,
					centerY, (short) Grasslands0Decorator.TREE_10.getTileId(),
					Grasslands0Decorator.TREE_10.getData());
		}
	}
